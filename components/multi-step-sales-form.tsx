...
export function MultiStepSalesForm({ onSubmit }: { onSubmit: (data: any) => void }) {
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-[600px] w-full max-w-4xl mx-auto flex items-center justify-center">
        <div className="text-center">
          <CheckCircle2 className="w-16 h-16 text-green-500 mx-auto mb-4"/>
          <h2 className="text-3xl font-semibold text-foreground mb-3">Thank you!</h2>
          <p className="text-lg text-muted-foreground leading-relaxed max-w-md">
            We've received your submission. Our AI is analyzing your request, and we'll be in touch shortly.
          </p>
        </div>
      </div>
    )
